...
import { SecondaryNodeModal } from '@/components/NodeModal/SecondaryNodeModal';
...
export default function ForceGraph({ 
  ...
  const getNodeDescription = (node: Node | null) => {
    if (!node) return '';
  ...
  return (
    <>
      ...
      />
      {selectedNode?.group === 'secondary' ? (
        <SecondaryNodeModal
          isOpen={!!selectedNode}
          onClose={() => setSelectedNode(null)}
          node={selectedNode}
          childNodes={getChildNodes(selectedNode)}
          description={getNodeDescription(selectedNode)}
        />
